...
| [`xmx-joint-matrix.md`](xmx-joint-matrix.md) | SYCL Joint Matrix extensions, programming model, DPAS systolic tile operations. | M7 |
| [`b60-matrix-caps.md`](b60-matrix-caps.md) | Verified hardware matrix combinations on Intel Arc Pro B60 (53 combinations: INT8, FP16, BF16, TF32; no native INT4). | M7, M10 |
