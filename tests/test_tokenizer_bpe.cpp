...
int main() {
    ...
    // 4. Load real official checkpoint tokenizer
    std::cout << "[Test 4] Loading real tokenizer from H:\\Models\\Qwen3.8-27B\\tokenizer.json..." << std::endl;
    QwenTokenizer real_tok;
    std::string load_err;
    bool loaded = real_tok.load_from_file(R"(H:\Models\Qwen3.8-27B\tokenizer.json)", &load_err);
